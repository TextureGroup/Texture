...
- Fix an issue in layout transition that causes it to unexpectedly use the old size range [Huy Nguyen](https://github.com/nguyenhuy) [#464](https://github.com/TextureGroup/Texture/pull/464)
