...
- [ASImageNode] Fix incorrect contentsScale when pre-compositing rounded corners on images. [Jason Yu](https://github.com/yxztj). [#1152](https://github.com/TextureGroup/Texture/pull/1152)
