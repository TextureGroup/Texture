...
- [API CHANGES] Remove deprecated APIs in collection node and its protocols [Huy Nguyen](https://github.com/nguyenhuy) [#722](https://github.com/TextureGroup/Texture/pull/722)
