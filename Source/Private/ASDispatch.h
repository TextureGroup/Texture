 ...
 */
AS_EXTERN void ASDispatchApply(size_t iterationCount, dispatch_queue_t queue, NSUInteger threadCount, void(NS_NOESCAPE ^work)(size_t i));
 ...
 * decides the system can't handle it. In reality this rarely happens.
 */
AS_EXTERN void ASDispatchAsync(size_t iterationCount, dispatch_queue_t queue, NSUInteger threadCount, void(NS_NOESCAPE ^work)(size_t i));
