...
AS_INLINE ASSizeRange ASCollectionLayoutElementSizeRangeFromSize(CGSize size)
{
...
AS_INLINE void ASCollectionLayoutSetSizeToElement(CGSize size, ASCollectionElement *element)
{
