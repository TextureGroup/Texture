...
AS_INLINE BOOL isFlexibleInBothDirections(const ASStackLayoutSpecChild &child)
{
 ...
 */
AS_INLINE BOOL useOptimizedFlexing(const std::vector<ASStackLayoutSpecChild> &children,
                                              const ASStackLayoutSpecStyle &style,
                                              const ASSizeRange &sizeRange)
{
